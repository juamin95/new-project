...
| P0 (MVP) | Migration Prozess-Skills | bauprojekt, projekt-ohne-angebot, abo, hero-stammdaten — mit Validierungstest | Approved |

### Phase 2 — Cockpit (Web-App für Marvin)

| Priorität | Feature | Inhalt | Status |
|----------|---------|--------|--------|
| P0 (MVP) | Supabase-Infrastruktur | Bestehendes Website-Projekt („juamin95's Project", leads + projekte) erweitern: Auth, Cockpit-Schema | In Progress |
...
- **Skill-Kategorien nach Leistungsarten:** künftige Skills je Kategorie (Grünpflege, Steinreinigung, Zaunbau, Rollrasen, …) — nach Phase 1 gemeinsam durchgehen
