...
|----|---------|--------------|------|----------------|--------|------|---------|
| PROJ-2 | Vault-Gerüst & Governance | Repo-2-Struktur, Ordnerlogik, Regeln, Migrations-Filter (nur GRÜNSCHNITT + OS) | P0 | Keine | In Progress | [Spec](PROJ-2-vault-geruest-governance.md) | 2026-07-17 |
