...
| PROJ-16 | Migration Tool-Ebene (Hero-CLI + Introspection) | hero-tools CLI + introspect.py vom VPS ins Repo, Setup + Funktionstest gegen Hero | P0 | PROJ-2 | In Progress | [Spec](PROJ-16-migration-tool-ebene.md) | 2026-07-18 |
