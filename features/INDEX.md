...
| ID | Feature | Beschreibung | Prio | Abhängigkeiten | Status | Spec | Created |
|----|---------|--------------|------|----------------|--------|------|---------|
| PROJ-1 | Supabase-Infrastruktur | Website-Projekt „juamin95's Project" (bnzpdujupmmrwcbunbql) erweitern: Auth, Cockpit-Schema, Env-Setup | P0 | Keine | Planned | [Spec](PROJ-1-supabase-infrastruktur.md) | 2026-07-17 |
