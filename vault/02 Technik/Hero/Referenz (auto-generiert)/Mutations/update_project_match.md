...
| `manual_assigned_user_ids` | `[Int]` | — | if not null, this replaces all manually assigned users. if empty array, all manually assigned users are removed. |
